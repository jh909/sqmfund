...
"1000px":{range:"481-1200",containers:900}}}},defaults:{breakpoint:{test:null,config:null,elements:null},config_breakpoint:{range:"",containers:900,lockViewport:!1,viewportWidth:!1,hasStyleSheet:!0,grid:{}}},DOMReady:null,getElementsByClassName:null,indexOf:null,iterate:null,extend:function(b,c){a.iterate(c,function(d){"object"==typeof c[d]?("object"!=typeof b[d]&&(b[d]={}),a.extend(b[d],c[d])):b[d]=c[d]})},parseMeasurement:function(a){var c;"string"!==typeof a?a=[a,"px"]:"fluid"==a?a=[100,"%"]:(c=
